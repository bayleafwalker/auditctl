...
The machine-readable routing and hook policy is `auditctl.dispatch.json`. Validate reusable packets with `python /projects/dev/agentops/scripts/validate_verification_artifacts.py --root .`.
